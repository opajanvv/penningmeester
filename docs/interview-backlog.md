...
- **Declaraties**: Hoe boek je een declaratie die als gift wordt beschouwd?
...
- **Collecten afstorten**: Hoe gaat het afstorten van collectegeld? (u01)
- **Betalingsverkeer**: Klaarzetten en accorderen in SKG, incasso's
- **Overdracht**: Wat moet gedocumenteerd zijn voor een opvolger?
