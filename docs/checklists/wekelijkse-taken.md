...
Zie [`../processen/bankafschriften-importeren.md`](../processen/bankafschriften-importeren.md) voor het volledige stappenplan (exporteren uit SKG, CSV importeren in Google Sheets, saldocheck).

---

## How-to: Betalingen verhuurfacturen controleren

Zie [`../processen/verhuur-facturatie.md`](../processen/verhuur-facturatie.md), sectie "Wekelijkse controle: betalingen verhuurfacturen".
...
Zie [`../processen/betalingen-accorderen.md`](../processen/betalingen-accorderen.md) voor het stappenplan.
