...
1. Open de sheet **'Bestelling Collectebonnen'** (privé account) — de laatste rij toont de meest recent doorgegeven bestelling
2. Zoek in de wijkkas-mutaties (Sheet of SKG) of er daarna nog nieuwe bestellingen zijn binnengekomen
...
4. Nieuwe bestellingen overnemen in de sheet 'Bestelling Collectebonnen'
